'''
    ...
    Batch : FTDS-008-HCK
    Objective : program ini dibuat untuk melakukan automatisasi transfrom dan load
    dari postgresql ke Elasticsearch dan membuatkan Visualisai menggunakan Kibana
    dataset yang akan digunakan dalam projek kali ini adalah dataset EV_CAR
